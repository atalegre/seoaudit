  ...
  return (
    <div className="px-4 py-8 max-w-6xl mx-auto">
      ...
      <p className="text-lg text-muted-foreground mb-6 max-w-3xl mx-auto">
        Analise gratuitamente o seu site e descubra como melhorar a sua presença nos motores de busca.
      </p>
      <form onSubmit={handleSubmit} className="w-full max-w-xl mx-auto flex flex-col gap-3 md:flex-row md:gap-2">
