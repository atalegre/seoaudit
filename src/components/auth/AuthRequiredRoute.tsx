  ...
  return (
    <>
      ...
      <div className="relative h-full">
        ...
        {/* Overlay with login dialog - positioned in the middle of the viewport with scrolling */}
        <div className="absolute inset-0 overflow-auto flex items-center justify-center py-16 px-4">
          <div className="bg-white/95 rounded-lg shadow-md w-full max-w-md z-50 m-auto">
            <div className="p-6">
